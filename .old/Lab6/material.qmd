...
## (OPTIONAL) Bayesian parameter estimation: Quadratic approximation
...
assume that we can build a prior that the prey density is in the order of 100 and 
that the predation rate is in the order of 50 With this information we can already
come up with *Weakly Informative Priors* (WIPs for short) that only informs about
