...
1. Choose (at least) two appropriate functions based on the type of data or the shape of the data.
...
```{block2, type= "solutionbox", latex.options="{block-green}{3}", echo = params$solution}
