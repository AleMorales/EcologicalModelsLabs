...
while at the same time maintaning some level of consistency.

Biggest changes include:

- Use of Stan for all the Bayesian modeling (a supplement is provided on how to translate
from BUGS to Stan and the overall structure of Stan programs).
